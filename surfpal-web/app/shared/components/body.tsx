...
//             <div className="relative pt-10 pb-10 md:pt-20 md:pb-16 flex divide-x">
//                 <div className="w-2/3 max-w-3xl mx-auto text-center pb-12 md:pb-16 border border-red flex flex-col space-y-7 ml-auto">
//                     <div className="text-white">Image Recognition </div>
//                     <div className="text-white">Summarization</div>
//                     <div className="text-white">Navigation Assistance</div>
//                     <p className="text-xl text-white mb-8" data-aos="fade-up" data-aos-delay="200">
//                         SurfPal helps you to summarize any piece of text and Recognize the Images in the website and also helps to Navigate into relevant links within the website. And mainly, users can customize their profile according to their preferences.
//                     </p>
//                 </div>
...
//             <section className="md:container mt-10 mb-16">

//             </section>

//             {/* <section id="extensionFeature" className="my-10">
//                 <div className="max-w-6xl mx-auto px-4 sm:px-6">
//                     <div className="bg-gray-800 py-10 px-8 md:py-16 md:px-12">
//                         <div className="flex flex-col justify-between items-center">
//                             <div className="mb-6 text-center"><h3 className="h3 text-white mb-2">Browser Extensions</h3>
//                             <p className="text-gray-400 text-lg">Use TLDR This browser extensions to summarize any webpage in a click.</p>
//                             </div>
//                         <div className="flex flex-col gap-5 w-full max-w-[220px] justify-center">
//                             <a class="text-white bg-white hover:opacity-80 h-16 rounded-md" href="https://chrome.google.com/webstore/detail/tldr-this-free-automatic/jjmnbidkmmabkalampbilajnheeokpoj" target="_blank">
//                             </a>
//                                     <a class="btn text-white border-1 rounded-md border-solid border-white hover:opacity-80 h-16" href="https://addons.mozilla.org/en-US/firefox/addon/tldr-this-auto-text-summary/" target="_blank">
//                                         <img alt="Chrome Web Store" loading="lazy" width="200" height="60" decoding="async" data-nimg="1" style="color:transparent" src="/images/mozillaWebStore.svg">
//                                     </a>
//                         </div>
//                     </div>
//                 </div>
...
//                                         <img src="/surfpal-web/app/assets/images.png" alt="Your Image Description" className="w-full h-auto"/>
//                                         </div>
...
//             {/* <section id="useCase" className="relative w-full">
//                 <div className="relative md:container px-4 sm:px-6">
//                     <section>
//                         <div className="max-w-6xl mx-auto px-4 sm:px-6">
//                             <div className="py-12 md:py-20 border-t border-gray-800">
//                                 <div className="max-w-3xl mx-auto text-center pb-12 md:pb-20">
//                                     <h2 className="h2 mb-4">Who is TLDR This for?</h2>
//                                     <p className="text-xl text-gray-400">TLDR This is a summarizing tool designed for students, writers, teachers, institutions, journalists, and any internet user who needs to quickly understand the essence of lengthy content.</p>
//                                 </div>
//                                 <div className="max-w-sm mx-auto grid gap-8 md:grid-cols-2 lg:grid-cols-3 lg:gap-16 items-start md:max-w-2xl lg:max-w-none" data-aos-id-blocks="true">
//                                     <div className="relative flex flex-col items-center" data-aos="fade-up" data-aos-anchor="[data-aos-id-blocks]">
//                                         <h3 className="h3 mb-2 text-center">Anyone with access to the Internet</h3>
//                                         <p className="text-lg text-gray-400 text-center">TLDR This is for anyone who just needs to get the gist of a long article. You can read this summary, then go read the original article if you want to.</p>
//                                     </div>
//                                     <div className="relative flex flex-col items-center" data-aos="fade-up" data-aos-delay="100" data-aos-anchor="[data-aos-id-blocks]">
//                                         <h3 className="h3 mb-2 text-center">Students</h3>
//                                         <p className="text-lg text-gray-400 text-center">TLDR This is for students studying for exams, who are overwhelmed by information overload. This tool will help them summarize information into a concise, easy to digest piece of text.</p>
//                                     </div>
//                                     <div className="relative flex flex-col items-center" data-aos="fade-up" data-aos-delay="200" data-aos-anchor="[data-aos-id-blocks]">
//                                         <h3 className="h3 mb-2 text-center">Writers</h3>
//                                         <p className="text-lg text-gray-400 text-center">TLDR This is for anyone who writes frequently, and wants to quickly summarize their articles for easier writing and easier reading.</p>
//                                     </div>
//                                     <div className="relative flex flex-col items-center" data-aos="fade-up" data-aos-delay="300" data-aos-anchor="[data-aos-id-blocks]">
//                                         <h3 className="h3 mb-2 text-center">Teachers</h3>
//                                         <p className="text-lg text-gray-400 text-center">TLDR This is for teachers who want to summarize a long document or chapter for their students.</p>
//                                     </div>
//                                     <div className="relative flex flex-col items-center" data-aos="fade-up" data-aos-delay="400" data-aos-anchor="[data-aos-id-blocks]">
//                                         <h3 className="h3 mb-2 text-center">Institutions</h3>
//                                         <p className="text-lg text-gray-400 text-center">TLDR This is for corporations and institutions who want to condense a piece of content into a summary that is easy to digest for their employees/students.</p>
//                                     </div>
//                                     <div className="relative flex flex-col items-center" data-aos="fade-up" data-aos-delay="500" data-aos-anchor="[data-aos-id-blocks]">
//                                         <h3 className="h3 mb-2 text-center">Journalists</h3>
//                                         <p className="text-lg text-gray-400 text-center">TLDR This is for journalists who need to summarize a long article for their newspaper or magazine.</p>
//                                     </div>
//                                 </div>
//                             </div>
//                         </div>
...
//                 <div className="mx-auto md:container px-4 xl:px-6 md:px-6">
//                     <section>
//                         <div className="max-w-6xl mx-auto px-4 sm:px-6">
//                             <div className="relative bg-purple-600 py-10 px-8 md:py-12 md:px-12" data-aos="fade-up">
//                                 <div className="absolute right-0 top-0 -ml-40 pointer-events-none" aria-hidden="true">
//                                     <svg width="238" height="110" fill="none" xmlns="http://www.w3.org/2000/svg">
//                                         <defs><linearGradient id="illustration-04" x1="369.483" y1="-84.633" x2="139.954" y2="-199.798" gradientUnits="userSpaceOnUse">
...
//                                         <h3 className="h3 text-white mb-2">Focus on the Value, Not the Noise.</h3>
//                                     </div>
//                                     <div className="flex flex-col sm:flex-row justify-center max-w-xs mx-auto sm:max-w-md lg:max-w-none">
//                                     <a className="btn text-purple-600 bg-purple-100 hover:bg-white shadow" href="#uploadFileSection">START SUMMARIZING — IT'S FREE</a>
//                                     </div>
//                                 </div>
//                             </div>
//                         </div>
